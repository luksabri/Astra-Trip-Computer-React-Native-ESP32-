...
git clone [https://github.com/SEU_USUARIO/astra-trip-computer.git](https://github.com/SEU_USUARIO/astra-trip-computer.git)
cd astra-trip-computer

# 2. Instale as dependências
npm install

# 3. Compile e instale a versão de desenvolvimento no dispositivo Android via USB
npx expo run:android

# 4. Inicie o servidor JavaScript Metro
